...
export const RemotionRoot: React.FC = () => (
  <>
    ...
    <Composition
      ...
      width={1080}
      height={1920}
      defaultProps={{"textos":{"tituloArriba":"VENDÉS EN MERCADOLIBRE","tituloAbajo":"Y TU MARGEN NO CIERRA","placa":"-20%","alturaSubtitulos":300,"tamanoLetra":70,"estiloSubtitulos":"limpio" as const,"estiloCamara":"auto" as const},"footage":"grabaciones/cupones.mp4","footageFrames":1058,"introArchivo":"ai/cupones-intro.png","captionsFile":"captions/cupones.json","capturaArchivo":"","capturaTargetX":0.5,"capturaTargetY":0.42,"reglasExtra":"[]"}}
      calculateMetadata={({ props }) => ({
