...
catch (e) { die(`${e.message}\n\nUso: node scripts/ajustar-video.mjs <tema> [--subs-altura N] [--subs-letra N] [--subs-estilo limpio|resaltado] [--camara auto|reposado|dinamico|agresivo] [--cta-x 0..1] [--cta-y 0..1] [--titulo-arriba "..."] [--titulo-abajo "..."] [--placa "..."]`); }
