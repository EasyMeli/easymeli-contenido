...
Deja acá una **captura de pantalla real** por tema, con el nombre del guion:

    public/capturas/<tema>.png      (ej: cupones.png)

Qué mostrar: la pantalla a la que quieres mandar a la gente (tu **perfil con el
...
Si NO dejas captura, el cierre cae solo a la **tarjeta de texto** de siempre
